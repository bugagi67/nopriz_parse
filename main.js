...
h1 {
  margin-bottom: 20px; /* Добавляем отступ между заголовком и инпутами */
}
...
.pars__button {
  display: block;
  width: 150px;
  margin: 20px auto 0; /* Центрируем кнопку и добавляем отступы */
  padding: 10px;
...
;// ./src/js/app.js
var _excluded = ["id", "member_type", "member_status", "inventory_number", "full_description", "registration_number", "registry_registration_date", "suspension_date", "other_information", "sro", "members_total_liability"];
...
var parsButton = document.querySelector(".pars__button");
var entryPointInput = document.querySelector(".entrypoint");
var endPointInput = document.querySelector(".endpoint");
entryPointInput.addEventListener("keypress", function (e) {
...
function _main() {
  _main = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(url, body, entrypage, endpage) {
    var serch,
      counter,
      array,
      postData,
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _postData = function _postData3() {
            _postData = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(url, body) {
              var response, a;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  ...
                  case 5:
                    a = _context.sent;
                    return _context.abrupt("return", a.data.data);
                  case 7:
                  case "end":
          ...
          postData = function _postData2(_x5, _x6) {
            return _postData.apply(this, arguments);
          };
          serch = _args2.length > 4 && _args2[4] !== undefined ? _args2[4] : "Проект ";
          counter = entrypage;
          array = [];
          if (!(counter < endpage)) {
            _context2.next = 17;
        ...
        case 7:
          ...
          body = {
            ...
            pageCount: "100",
            sortBy: {},
            searchString: "".concat(serch)
          };
          _context2.next = 11;
          return postData(url, body);
        case 11:
          result = _context2.sent;
          array.push.apply(array, _toConsumableArray(result));
          counter++;
        case 14:
          i++;
          _context2.next = 7;
...
function editingJson(data) {
  var cleanedData = data.map(function (_ref) {
    var id = _ref.id,
      member_type = _ref.member_type,
      member_status = _ref.member_status,
      inventory_number = _ref.inventory_number,
      full_description = _ref.full_description,
      registration_number = _ref.registration_number,
      registry_registration_date = _ref.registry_registration_date,
      suspension_date = _ref.suspension_date,
      other_information = _ref.other_information,
      sro = _ref.sro,
      members_total_liability = _ref.members_total_liability,
